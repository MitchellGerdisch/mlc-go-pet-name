...
namespace Pulumi.Pet
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Pet.version.txt");
    ...
    internal sealed class PetResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public PetResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
